import type { Theme, TimeRange } from '@/types';
import type { DataTypes } from './data.interface';
import type { ClearResult } from './message.interface';
import type { DataTypeInfo } from './preset.interface';
import type { ScheduleConfig, Statistics } from './settings.interface';
