    ...
    <footer className="border-border mt-4 border-t pt-3">
      <div className="flex flex-col items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-full bg-yellow-100 px-3 py-1.5 text-xs font-medium text-yellow-700 hover:bg-yellow-200 dark:bg-yellow-400/15 dark:text-yellow-400 dark:hover:bg-yellow-400/25"
        >
